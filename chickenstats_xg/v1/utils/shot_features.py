...
xg_fields = {
    ...
    "coords_x": {"dtype": float, "nullable": False, "default": False, "required": True},
    "coords_y": {"dtype": float, "nullable": False, "default": False, "required": True},
    "is_rebound": {"dtype": int, "nullable": False, "default": 0, "required": True},
    "rush_attempt": {"dtype": int, "nullable": False, "default": 0, "required": True},
    "is_scramble": {"dtype": int, "nullable": False, "default": 0, "required": True},
    ...
    # Passthrough — needed for pred_goal join operations; excluded from training feature matrix
    "event_idx": {"dtype": int, "nullable": False, "default": False, "required": False},
    ...
    # Model 1 output — passed as base_margin to pred_goal (log-odds); not a direct feature
    "base_xg": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Shooter GxG rolling windows — metric = goal − base_xg; 4 windows × 2 values + ewma = 9 columns
    ...
    "shooter_gax_ewma": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Goalie GSAx rolling windows — metric = base_xg − goal; 4 windows × 2 values + ewma = 9 columns
    ...
    "goalie_gsax_ewma": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Shooter RAPM — lagged 1 season, situation-matched; 3 metrics × 2 dims = 6 columns
    "shooter_rapm_xg_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_xg_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_corsi_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_corsi_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_goals_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_goals_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Shooter RAPM career — TOI-weighted mean of per-season coefficients; 3 metrics × 2 dims = 6 columns
    "shooter_rapm_career_xg_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_career_xg_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_career_corsi_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_career_corsi_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_career_goals_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_rapm_career_goals_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Teammates RAPM — mean of on-ice teammates (shooter excluded); 3 metrics × 2 dims = 6 columns
    "teammates_rapm_xg_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_xg_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_corsi_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_corsi_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_goals_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_goals_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Teammates RAPM career — TOI-weighted mean; 3 metrics × 2 dims = 6 columns
    "teammates_rapm_career_xg_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_career_xg_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_career_corsi_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_career_corsi_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_career_goals_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "teammates_rapm_career_goals_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Opponent RAPM — mean of opposing on-ice skaters; 3 metrics × 2 dims = 6 columns
    "opp_rapm_xg_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_xg_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_corsi_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_corsi_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_goals_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_goals_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Opponent RAPM career — TOI-weighted mean; 3 metrics × 2 dims = 6 columns
    "opp_rapm_career_xg_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_career_xg_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_career_corsi_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_career_corsi_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_career_goals_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "opp_rapm_career_goals_def": {"dtype": float, "nullable": True, "default": False, "required": False},
    # Shooter vs. teammates differential — offensive only; defensive is inherently net of shooter
    "shooter_vs_teammates_rapm_xg_off": {"dtype": float, "nullable": True, "default": False, "required": False},
    "shooter_vs_teammates_rapm_corsi_off": {"dtype": float, "nullable": True, "default": False, "required": False},
...
def prep_data(
    ...
    _prior_event_types = ["SHOT", "MISS", "BLOCK", "GIVE", "TAKE", "HIT"]
    _base_cond = pl.all_horizontal(list(conditions))
    ...
    select_columns = [
        ...
        "home_on_api_id",
        "away_on_api_id",
        # pred_goal talent features — absent in base_xg pipeline, picked up when present
        "base_xg",
        # Shooter GxG (goal − base_xg)
        "shooter_gax_career",
        ...
        "goalie_gsax_ewma",
        # Shooter RAPM prior season (3 metrics × 2 dims)
        "shooter_rapm_xg_off",
        "shooter_rapm_xg_def",
        "shooter_rapm_corsi_off",
        "shooter_rapm_corsi_def",
        "shooter_rapm_goals_off",
        "shooter_rapm_goals_def",
        # Shooter RAPM career (TOI-weighted mean)
        "shooter_rapm_career_xg_off",
        "shooter_rapm_career_xg_def",
        "shooter_rapm_career_corsi_off",
        "shooter_rapm_career_corsi_def",
        "shooter_rapm_career_goals_off",
        "shooter_rapm_career_goals_def",
        # Teammates RAPM prior season (mean of on-ice teammates, shooter excluded)
        "teammates_rapm_xg_off",
        "teammates_rapm_xg_def",
        "teammates_rapm_corsi_off",
        "teammates_rapm_corsi_def",
        "teammates_rapm_goals_off",
        "teammates_rapm_goals_def",
        # Teammates RAPM career (TOI-weighted mean)
        "teammates_rapm_career_xg_off",
        "teammates_rapm_career_xg_def",
        "teammates_rapm_career_corsi_off",
        "teammates_rapm_career_corsi_def",
        "teammates_rapm_career_goals_off",
        "teammates_rapm_career_goals_def",
        # Opponent RAPM prior season (mean of opposing on-ice skaters)
        "opp_rapm_xg_off",
        "opp_rapm_xg_def",
        "opp_rapm_corsi_off",
        "opp_rapm_corsi_def",
        "opp_rapm_goals_off",
        "opp_rapm_goals_def",
        # Opponent RAPM career (TOI-weighted mean)
        "opp_rapm_career_xg_off",
        "opp_rapm_career_xg_def",
        "opp_rapm_career_corsi_off",
        "opp_rapm_career_corsi_def",
        "opp_rapm_career_goals_off",
        "opp_rapm_career_goals_def",
        # Shooter vs. teammates differential prior season (offensive only)
        "shooter_vs_teammates_rapm_xg_off",
        "shooter_vs_teammates_rapm_corsi_off",
        "shooter_vs_teammates_rapm_goals_off",
        # Shooter vs. teammates differential career
        "shooter_vs_teammates_rapm_career_xg_off",
